...
cmake -G "Visual Studio 16 2019" -A Win32 -B "x86_32" -S ".." -D "CMAKE_TOOLCHAIN_FILE=%GITHUB_WORKSPACE%/vcpkg/scripts/buildsystems/vcpkg.cmake" || exit /b 1
@echo.
@echo.                             x86_32 (Debug)
...
cmake -G "Visual Studio 16 2019" -A x64 -B "x86_64" -S ".."  -D "CMAKE_TOOLCHAIN_FILE=%GITHUB_WORKSPACE%/vcpkg/scripts/buildsystems/vcpkg.cmake" || exit /b 1
@echo.
@echo.                             x86_64 (Debug)
